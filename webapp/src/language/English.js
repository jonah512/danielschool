const English = {
    common: {
        ...
        uploadsettingsinfo: "Upload new images to replace existing ones. Supported formats: JPEG, PNG. Maximum file size: 5MB. Original files will be automatically backed up.",
        failedloadimages: "Failed to load images information",
        uploadedsuccessfully: "{0} uploaded successfully for {1}",
        uploadedlocally: "{0} uploaded locally for {1} (API not available)",
        failedupload: "Failed to upload file. Please try again.",
        restoredsuccessfully: "{0} restored to original version",
        restoreddefault: "{0} restored to default (API not available)",
        failedrestore: "Failed to restore image. Please try again."
    },
    cmsconnection: {
    ...
    settings: {
        ...
        uploadinstructions: "Upload new images to replace existing ones. Supported formats: JPEG, PNG. Maximum file size: 5MB. Original files will be automatically backed up.",
        ...
        registrationstep5: "Registration Step 5",
        schoollogo: "Daniel School Logo",
        welcomeimage: "Welcome Introduction Image",
