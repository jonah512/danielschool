const Defines = {
  ...
  koreanLevelOptions: [
    ...
    { level: 2, label: '쌍자음 5개와 복합 모음 11개를 공부합니다.', example: '찌개, 머리띠, 쓰레기, 돼지, 과자, 시계'},
    ...
    { level: 7, label: '목적어와 부사어가 들어 간 문장을 공부합니다.', example: '저는 밥을 먹어요. 저는 학교에 가요. 저는 공원에서 자건거를 타요. 자리에 앉아요.'},
  ...
  UTC_GAP: -10 // UTC-10 for HST (Hawaii Standard Time)
};
